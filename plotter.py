...
sh.rmtree('./diagrams')
os.mkdir("./diagrams")
X = np.loadtxt("./Outputs/st_1000,nn_1000,mu_0.000100,ref_env_=0.000000/numrun_2/Alive.txt")
Y = np.loadtxt("./Outputs/st_1000,nn_1000,mu_0.000100,ref_env_=0.000000/numrun_2/du_Alive.txt")
